...
if ( class_exists( 'WP_Customize_Section' ) ) {
	...
	class Aster_Storefront_Upsell_Section extends WP_Customize_Section {
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="dark_fitness_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
