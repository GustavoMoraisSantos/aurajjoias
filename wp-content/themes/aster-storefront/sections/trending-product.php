...
function aster_storefront_render_service_section( $aster_storefront_args ) { ?>
		...
		$trending_product_heading = get_theme_mod( 'aster_storefront_trending_product_heading', '' );
		?>
		<div class="asterthemes-wrapper">
			<?php if ( ! empty( $trending_product_heading ) ) { ?>
				<div class="header-contact-inner">
					<h3><?php echo esc_html( $trending_product_heading ); ?></h3>
				</div>
			<?php } ?>
      ...
      if ( class_exists( 'WooCommerce' ) ) {
        ...
        <div class="product-box"> 
	        <?php $loop = new WP_Query( $aster_storefront_args );
